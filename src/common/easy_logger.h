...
static inline void
_easy_logger(FILE *const stream,
             ...
             ...)
{
    ...
    fprintf(stream,
            "[%s] %s:%d : ",
            EASY_LOGGER_LEVEL_STRINGS[log_level],
            file,
            line);
    va_start(ap, format);
