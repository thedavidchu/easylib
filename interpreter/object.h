...
struct ObjectType {
    ...
    int (*from_cstr)(struct Object *const me, struct ObjectType const *const type, char const *const text, char const **end_cstr);
...
int phony_from_cstr(struct Object *const me, struct ObjectType const *const type, char const *const cstr, char const **end_cstr);
// String, array, or table
